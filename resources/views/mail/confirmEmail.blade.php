                ...
                <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
                    ...
                    <tr>
                        <td valign="middle" class="hero bg_white" style="padding: 3em 0 2em 0;">
                            <div class="text" style="text-align: center;">
                                <h1 class="primary">Olá Luciana!</h1>
                    ...
                    <tr>
                        <td valign="middle" class="hero bg_white" style="padding: 2em 0 1em 0;">
                            <div class="text" style="text-align: center;">
                                <button class="btn">Ativar minha conta</button>
                            </div>
                        </td>
                    </tr>
                    <tr>
                                    ...
                                    <td>
                                        <div class="text" style="padding: 0 2.5em; text-align: center;">
                                            ...
                                            <p style="font-size: 16px; margin-top:50px">
                                                Caso você não tenha se registrado para esta conta, ignore esta mensagem e a conta será removida.
                                            </p>
                                            <p style="font-size: 16px; margin-top:30px">
                                                Em caso de dúvidas, envie um e-mail para <a href="mail:suporte@bitcointrade.com.br">suporte@bitcointrade.com.br</a>.
                                            </p>
                                        </div>
                                    </td>
                                </tr>
                ...
                <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
                    ...
                    <tr>
                        <td class="bg_light" style="text-align: center;">
                            Cadastrado em: <b style="margin-left: 5px">{{ date('d M Y - H:i') }}</b>
